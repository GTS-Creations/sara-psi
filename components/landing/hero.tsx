        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-xl">
              ...
              Utilizo abordagens como TCC, Terapia ABA, Terapia do Esquema e Ludoterapia 
              para ajudar crianças a crescerem emocionalmente saudáveis.
            </p>
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">+500 famílias</span> atendidas
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-card rounded-xl shadow-lg p-4 border border-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Consultas por videochamada</p>
                  </div>
                </div>
              </div>
